...
export class MakeAllTables1736554092545 implements MigrationInterface {
    name = 'MakeAllTables1736554092545'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_stores" ("store_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_53afbce52c22d3ba43fdbd3beff" PRIMARY KEY ("store_id", "user_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_aacfd082707f731d4d4c8805d0" ON "user_stores" ("store_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_63e8380a29134975cd835c5254" ON "user_stores" ("user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "user_stores" ADD CONSTRAINT "FK_aacfd082707f731d4d4c8805d03" FOREIGN KEY ("store_id") REFERENCES "stores"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_stores" ADD CONSTRAINT "FK_63e8380a29134975cd835c52549" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_63e8380a29134975cd835c5254"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_aacfd082707f731d4d4c8805d0"`);
